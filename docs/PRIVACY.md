# Privacy Policy — Idira Marketplace Importer
...
> should weigh specifically: (1) the extension's name, "Idira Marketplace Importer," uses a
...
Idira Marketplace Importer adds an "Import to tenant" button to a product page on the Idira
...
2. Find "Idira Marketplace Importer" and open **Details**.
